  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        bool isSearching = controller.searchQuery.isNotEmpty;
          ...
          children: [
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    /// Hide Store Info when keyboard is open
                    if (!isKeyboardOpen) ...[
                      Obx(() {
                        return Column(
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          Get.to(() => StoreInformationView(
                                                storeDetails:
                                                    controller.storeItem.value.storeDetails,
                                              ));
                                        },
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              Text(
                                                'Store Info',
                                                style: AppTextStyle.montserrat(
                                                    fs: 13, c: Colors.black, fw: FontWeight.w600),
                                              ),
                                              SizedBox(width: 2),
                                  ...
                                  Divider(
                                      color: AppColor.greyFieldBorder, thickness: 1, height: 24)
                                ],
                              ),
                            ),
                          ],
                    ...
                    /// Header (Popular Items or Search Products)
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 16),
                      child: Row(
                        children: [
                          Text(
                            isSearching ? "Search Products" : "Popular Items",
                          ...
                          return Center(
                            child: Padding(
                              ...
                              child: Text(
                                "No Items Found",
                                style: AppTextStyle.montserrat(
                                    fs: 14, fw: FontWeight.w500, c: AppColor.greyText),
                              ),
                            ),
                          );
                        }
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        Positioned(
                                          ...
                                          child: Obx(() {
                                            bool isFav =
                                                controller.wishlistStatus[itemId] ?? false;
