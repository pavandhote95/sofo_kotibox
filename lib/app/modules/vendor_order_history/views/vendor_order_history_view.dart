...
//   const VendorOrderHistoryView({super.key});
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('VendorOrderHistoryView'),
//         centerTitle: true,
//       ),
//       body: const Center(
//         child: Text(
//           'VendorOrderHistoryView is working',
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      itemCount: controller.allOrders.length, // ✅ show all
